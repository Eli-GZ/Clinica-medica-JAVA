...
<form class="user" action="SvMedicos" method="POST">
    <div class="form-group col">
        ...
        <div class="col-sm-4 mb-3 mx-auto">
            <input type="text" class="form-control mb-4" style="height:50px; font-weight: bolder; font-size: 16px; border: solid" id="especialidad" name="spec" placeholder="Especialidad">
        </div>
        <hr>
